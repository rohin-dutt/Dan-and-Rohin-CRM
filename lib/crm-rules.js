...
export function getRelationshipStatus(person, todayValue = new Date()) {
...
export function categorizePeople(people, todayValue = new Date()) {
  const sections = {
    overdue: [],
    dueThisWeek: [],
    comingUp: [],
  ...
  for (const person of people) {
    const status = getRelationshipStatus(person, todayValue);
